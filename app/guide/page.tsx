    ...
    <div style={st.page} className="grid-bg">
      <header style={st.header}>
        <div style={st.headerInner}>
          <Link href="/" style={st.logo}><img src="/logo-square.png" alt="入行 365" width={32} height={32} style={{ borderRadius: 8 }} /><span style={{ fontSize: 18, fontWeight: 700 }}>{"代码指南"}</span></Link>
